...
<p>&nbsp;</p>
		...
		<tr>
			...
			<td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
			   <div align="left" class="style1" style="margin-left:20px;"><strong><em><a href="Company_UProfile1.jsp?uname=<%=r_user%>&cname=<%=cname%>&ccat=<%=ccat%>&id=<%=id%>"> <%out.println(r_user);%> 
		    </a></em></strong></div></td>
...
<%					
		          ...
		          <p><a href="Company_TreeDetails.jsp?cname=<%=cname%>&ccat=<%=ccat%>&id=<%=id%>" class="style14">Back</a></p>
