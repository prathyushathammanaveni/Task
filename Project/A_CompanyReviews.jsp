...
<p>&nbsp;</p>
		...
		<tr>
			...
			<td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
			   <div align="left" class="style1" style="margin-left:20px;"><strong><em><a href="A_Company_UserProfiles.jsp?uname=<%=r_user%>&cname=<%=cname%>&ccat=<%=ccat%>&id=<%=id%>"> <%out.println(r_user);%> 
		    </a></em></strong></div></td>
...
<%					
		          ...
		          <p><a href="A_FindTopKword.jsp" class="style14">Back</a></p>
