...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Reviews on <%=request.getParameter("cname")%> Company </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
<p>&nbsp;</p>
  ...
  <form name="s" action="U_ReviewIns.jsp?cname=<%=cname%>&ccat=<%=ccat%>&id=<%=id%>&user=<%=user%>" method="post"  onSubmit="return valid()"  ons target="_top">
	...
	<table width="600" border="0" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr><td></td><td></td>
 						<td   width="200" align="left" valign="middle" height="45" style="color: #003399;"><div align="right" class="style9"  style="margin-left:20px;">Write Review </div></td>
	 ...
	 <p>&nbsp;</p>
	   ...
	   <h2>All User Reviews On This Company </h2>
		...
		<tr>
			...
			<td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
			   <div align="left" class="style1" style="margin-left:20px;"><strong><em> <%out.println(r_user);%> 
 		    </em></strong></div></td>
			 
			<%}else{%>
			<td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
			   <div align="left" class="style1" style="margin-left:20px;"><strong><em><a href="U_UProfile.jsp?uname=<%=r_user%>&id=<%=id%>&cname=<%=cname%>&ccat<%=ccat%>&user=<%=user%>"> <%out.println(r_user);%> 
		    </a></em></strong></div></td>
