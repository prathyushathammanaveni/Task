...
<head>
<title>Search Ratio By Keyword</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>All User Search Transactions By Keyword..</h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		  ...
		  <table width="568" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
              <tr>
                ...
                <td  width="167" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style52"><b>Keyword</b></div></td>
                <td  width="146" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style52"><b>Ratio</b></div></td>
              </tr>
              ...
              <%
						...
						try 
						{
							...
							int i=1,count=0;
						   	...
						   	String query="select distinct(keyword) from search_ratio"; 
					...
					String str1= "select ratio from search_ratio where keyword='"+keyword+"' ";
					...
					double r=Double.parseDouble(rs1.getString(1));
            ...
            <p align="right">&nbsp;</p>
            <p align="right">&nbsp;</p>
            <p align="left"><a href="Admin_Main.jsp" class="style14">Back</a> </p>
          </div>
          <div class="clr"></div>
        </div>
      </div>
