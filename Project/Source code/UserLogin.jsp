          ...
          <div class="post_content">
            <form id="form1" name="form1" method="post" action="Authentication.jsp?type=<%="user"%>">
				    <table width="464" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        <td height="40" align="center"><span class="style34 style5">Password (required)</span></td>
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <strong> New User?</strong></span><a href="UserRegister.jsp" class="style30 style4"> Register </a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
