...
<div class="main">
  ...
  <tr>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style7"><b>Id</b> </div></td>
    <td width="205" bgcolor="#FF0000"><div align="center" class="style7"><b>Company Name</b></div></td>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style7"><b>Category</b></div></td>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style7"><b>Image</b></div></td>
      <td width="293" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><b>Production</b> </div></td>
	  <td width="178" bgcolor="#FF0000"><div align="center" class="style7"><b>Description</b></div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style7 style7"><b>Crisis found to Manufacture</b></div></td>
	  <td width="205" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><b>Owner</b></div></td>
	  <td width="205" bgcolor="#FF0000"><div align="center" class="style7"><b>Started Year</b></div></td>
	  <td width="205" bgcolor="#FF0000"><div align="center" class="style7"><b>Chalenges faced Found in the scenario</b></div></td>
	  <td width="205" bgcolor="#FF0000"><div align="center" class="style7"><b>Rank</b></div></td>
	  <td width="205" bgcolor="#FF0000"><div align="center" class="style7"><b>Reviews</b></div></td>
  </tr>
  ...
  <tr>
	...
	<td><div align="center" style="color:#000000"><%=s5%></div></td>
     <td bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><%=s6%></div></td>
			   ...
			   <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style9"><strong> <a href="Company_ReviewDetails.jsp?cname=<%=s2%>&amp;ccat=<%=s3%>&id=<%=i%>" class="style3">Reviews</a> </strong></div></td>
  </tr>
...
%>
		          ...
		          <p>&nbsp;</p>
		          <p align="left"><a href="ViewOtherCompanies.jsp" class="style16">	Back</a></p>
