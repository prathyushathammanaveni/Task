...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome To Company User Registration.!</h2>
          <p class="infopost"><img src="images/Register.jpg" width="202" height="142" /></p>
          <div class="clr"></div>
		  <div class="post_content">
		  <form action="CompanyUserRegisterStatus.jsp" method="post" id="" enctype="multipart/form-data">
                     <p>
...
%>
              ...
              <span class="style33">
              <label for="gender"><span class="style4">Select Production Company(required)</span></label>
              </span>
			        <p class="style33">
                      <select id="s1" name="company" style="width:160px;" class="text">
