...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome To Company User Login..!</h2>
          <p align="center" class="infopost"><img src="images/Login.jpg" width="222" height="222" /></p>
          <div class="clr"></div>
      	...
      	try 
	{
           ...
           String query="select company FROM companies"; 
           Statement st=connection.createStatement();
           ResultSet rs=st.executeQuery(query);
          
	   while ( rs.next() )
	   {
			a1.add(rs.getString("company"));
...
%>
					<table width="464" border="0" cellspacing="2" cellpadding="2">
						<tr>
                        <td width="170" height="33"><div align="justify"><span class="style8 style38 style5 style4">Select Production Company</span></div></td>
                        <td width="274"><label>
                      ...
                      <tr>
                        <td width="200" height="46" align="center"><div align="justify"><span class="style34">
                          <label for="name"><span class="style4">Company Username (required)</span></label>
                        </span></div> </td>
                        <td width="253"><input id="name" name="cuserid" class="text" /></td>
                      </tr>
                      <tr>
                        <td height="30" align="center"><div align="justify"><span class="style34 style4"><label for="pass">Password (required)</label>
                        </span></div></td>
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <strong> New User?</strong></span><a href="CompanyUserRegister.jsp" class="style30"> Register </a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
