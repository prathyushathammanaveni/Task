...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>All User Reviews on <%=request.getParameter("cname")%> Company </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
<p>&nbsp;</p>
		...
		<tr>
			...
			<td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
			   <div align="left" class="style1" style="margin-left:20px;"><strong><em><a href="A_Company_UserProfile1.jsp?uname=<%=r_user%>&cname=<%=cname%>&ccat=<%=ccat%>&id=<%=id%>"> <%out.println(r_user);%> 
		    </a></em></strong></div></td>
...
<%					
		          ...
		          <p><a href="A_CompanyTreeDetails.jsp?cname=<%=cname%>&amp;ccat=<%=ccat%>&id=<%=id%>" class="style14">Back</a></p>
